...
import 'merge/backButtonAlert.dart';
...
class BackIntentKey extends Intent{}
class TabIntent extends Intent {}
class DirectionKeyIntent extends Intent {}
class _NextScreenState extends State<NextScreen> {
  ...
  Widget build(BuildContext context) {
    return Shortcuts(
      shortcuts: {
        LogicalKeySet(LogicalKeyboardKey.escape):BackIntentKey()
      },
      child: Actions(
        actions: {
          BackIntentKey: CallbackAction(onInvoke: ((intent) {
            print("back");
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(
                          ...
                          if (isMerging) {
                            return Actions(
                              actions: {
                                DirectionKeyIntent: CallbackAction(
                                    onInvoke: ((intent) {
                                      // selectedOutlet[i ++] ;
                                      // print (selectedOutlet[i ++]);
                                    })
                                )
                              },
                              child: Padding(
